...
class TestMoveGeneration(unittest.TestCase):
    ...
    def test_correctMovesInTestPosition1(self):
        board = ChessBoard('r2q1rk1/p2n1pp1/1p2pn1p/8/1P1Nb3/2BBP3/1PQ2P1P/3RK1R1 b - - 3 16')
    ...
    def test_correctMovesInTestPosition2(self):
        board = ChessBoard('r5r1/p4N1k/1p2p1pp/1P6/1q5P/3nPQ2/1P1RK3/6R1 b - - 5 30')
        moves = board.generate_possible_moves(False)
    ...
    def test_correctMovesInTestPosition3(self):
        board = ChessBoard('r6k/1q3pp1/4p3/8/p1pr1P2/P2n4/1PQB2PP/1R3RK1 w - - 0 26')
        moves = board.generate_possible_moves(True)
    ...
    def test_correctMovesInTestPosition4(self):
        board = ChessBoard('4r3/1pP1N1k1/2br1p1p/p1p1nP2/2PpP1P1/8/PP2B3/3R1K1R b - - 1 32')
        moves = board.generate_possible_moves(False)
    ...
    def test_correctMovesInTestPosition5(self):
        board = ChessBoard('5k2/1p6/p3b1Q1/4p1B1/4p3/PN1B2P1/1PP2q1P/7K w - - 0 27')
        moves = board.generate_possible_moves(True)
    ...
    def test_correctMovesInTestPositionWithCheck1(self):
        board = ChessBoard('r5k1/5pp1/4p3/7Q/p1p3P1/P1B1q3/1P5P/5RK1 w - - 3 35')
        moves = board.generate_possible_moves(True)
        stockfish_moves = ['f1f2', 'g1h1', 'g1g2']
        self.assertCountEqual(moves, stockfish_moves)

    def test_correctMovesInTestPositionWithCheck2(self):
        board = ChessBoard('r4rk1/3RN1pp/p4p2/1p6/6P1/7P/PnP5/5RK1 b - - 1 25')
        moves = board.generate_possible_moves(False)
        stockfish_moves = ['g8f7', 'g8h8']
        self.assertCountEqual(moves, stockfish_moves)

    def test_correctMovesInTestPositionWithEnPassant(self):
        board = ChessBoard('r1b1k2r/2q1bppp/p1nppn2/Pp6/4PP2/1NNB4/1PP3PP/R1BQ1RK1 w kq b6 0 12')
        moves = board.generate_possible_moves(True)
    ...
    def test_correctMovesInTestPositionWithCastling(self):
        board = ChessBoard('r3k2r/ppp2ppp/3p1q2/6b1/2P1P3/2NQ3P/PPP3P1/R3K2R b KQkq - 4 15')
        moves = board.generate_possible_moves(False)
